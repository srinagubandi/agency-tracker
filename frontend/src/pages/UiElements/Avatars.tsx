...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Agency Tracker - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Agency Tracker - React.js Tailwind CSS Admin Dashboard Template"
      />
