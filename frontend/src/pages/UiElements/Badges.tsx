...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Agency Tracker - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Agency Tracker - React.js Tailwind CSS Admin Dashboard Template"
      />
